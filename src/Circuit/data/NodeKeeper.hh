...
public:
  ...
  CircuitNodePtr AddNode(const std::string & /*name*/,
                         CircuitNodeType x = CircuitNodeType::DEFAULT,
                         CircuitUpdateType y = CircuitUpdateType::DEFAULT);

  CircuitNodePtr AddNodeAlias(const std::string & /*alias*/,
  ...
  void ACUpdateSolution(const std::string &, const std::string &,
