...
public:
  ...
  void assembleDC(const std::vector<double> &sol,
  ...
  // previous time steps
  void assembleTran(const double scl, const std::vector<double> &sol,
                    dsMath::RealRowColValueVec<double> *mat,
                    dsMath::RHSEntryVec<double> &rhs);
...
protected:
  virtual void assembleDC_impl(const std::vector<double> &sol,
                               dsMath::RealRowColValueVec<double> &mat,
                               dsMath::RHSEntryVec<double> &rhs) = 0;
  virtual void assembleTran_impl(const double scl,
