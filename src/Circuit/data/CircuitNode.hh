...
public:
  ...
  inline size_t getNumber() { return nodeNumber_; }

  inline CircuitUpdateType getUpdateType() { return updateType; }

  inline CircuitNodeType getCircuitNodeType() { return nodeType_; }
  ...
  size_t GetNumber() { return nodeNumber_; }
...
private:
  ...
  void SetNumber(size_t n) { nodeNumber_ = n; }
