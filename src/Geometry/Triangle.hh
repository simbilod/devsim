...
struct TriangleCompIndex {
  bool operator()(ConstTrianglePtr x, ConstTrianglePtr y) {
    return x->GetIndex() < y->GetIndex();
  }
};

template <typename DoubleType> Vector<DoubleType> GetCenter(const Triangle &);

template <typename DoubleType>
Vector<DoubleType> GetTriangleCenter(const Vector<DoubleType> &,
                                     const Vector<DoubleType> &,
                                     const Vector<DoubleType> &);

template <typename DoubleType>
Vector<DoubleType> GetTriangleCenter2d(const Vector<DoubleType> &,
                                       const Vector<DoubleType> &,
                                       const Vector<DoubleType> &);

template <typename DoubleType>
Vector<DoubleType> GetTriangleCenter3d(const Vector<DoubleType> &,
                                       const Vector<DoubleType> &,
                                       const Vector<DoubleType> &);
#endif
