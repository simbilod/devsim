...
/**
    ...
    1, 2, or 3 dimensions
*/
template <typename DoubleType> class Vector {
public:
  //      explicit Vector(DoubleType x = 0.0, DoubleType y = 0.0, DoubleType z =
  //      0.0);
  explicit Vector(DoubleType x = 0, DoubleType y = 0, DoubleType z = 0)
      : x(x), y(y), z(z) {}
  ...
  DoubleType magnitude() const { return sqrt(x * x + y * y + z * z); }
  ...
  const DoubleType &Getx() const { return x; }

  const DoubleType &Gety() const { return y; }

  const DoubleType &Getz() const { return z; }

  void Setx(DoubleType xn) { x = xn; }
  void Sety(DoubleType yn) { y = yn; }
  void Setz(DoubleType zn) { z = zn; }
...
template <typename DoubleType>
inline Vector<DoubleType> operator-(Vector<DoubleType> &v1,
                                    Vector<DoubleType> &v2) {
...
template <typename DoubleType>
inline Vector<DoubleType> cross_prod(const Vector<DoubleType> &v1,
                                     const Vector<DoubleType> &v2) {
  return v1.cross_prod(v2);
}

template <typename DoubleType>
inline DoubleType dot_prod(const Vector<DoubleType> &v1,
                           const Vector<DoubleType> &v2) {
...
template <typename DoubleType>
inline Vector<DoubleType> operator*(DoubleType x,
                                    const Vector<DoubleType> &vec) {
  return vec * x;
}
