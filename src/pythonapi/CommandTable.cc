...
DS_FUNCTION_TABLE(element_from_edge_model,
                  dsCommand::createTriangleFromEdgeModelCmd)
DS_FUNCTION_TABLE(element_pair_from_edge_model,
                  dsCommand::createTriangleFromEdgeModelCmd)
DS_FUNCTION_TABLE(element_from_node_model,
                  dsCommand::createEdgeFromNodeModelCmd)
...
DS_FUNCTION_TABLE(get_element_model_values,
                  dsCommand::printElementEdgeValuesCmd)
...
DS_FUNCTION_TABLE(interface_normal_model,
                  dsCommand::createInterfaceNormalModelCmd)
...
DS_FUNCTION_TABLE(get_interface_equation_list,
                  dsCommand::getInterfaceEquationListCmd)
DS_FUNCTION_TABLE(get_contact_equation_list,
                  dsCommand::getContactEquationListCmd)
DS_FUNCTION_TABLE(delete_equation, dsCommand::deleteEquationCmd)
DS_FUNCTION_TABLE(delete_interface_equation,
...
DS_FUNCTION_TABLE(get_contact_equation_command,
                  dsCommand::deleteContactEquationCmd)
DS_FUNCTION_TABLE(get_interface_equation_command,
                  dsCommand::deleteInterfaceEquationCmd)
// Meshing Commands
...
DS_FUNCTION_TABLE(create_contact_from_interface,
...
DS_FUNCTION_TABLE(create_interface_from_nodes,
...
DS_FUNCTION_TABLE(get_circuit_node_list,
                  dsCommand::circuitGetCircuitNodeListCmd)
DS_FUNCTION_TABLE(get_circuit_solution_list,
                  dsCommand::circuitGetCircuitSolutionListCmd)
DS_FUNCTION_TABLE(get_circuit_node_value,
                  dsCommand::circuitGetCircuitNodeValueCmd)
DS_FUNCTION_TABLE(set_circuit_node_value,
                  dsCommand::circuitGetCircuitNodeValueCmd)
DS_FUNCTION_TABLE(get_circuit_equation_number,
