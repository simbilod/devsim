...
MasterGILControl::MasterGILControl() { allow_threading(); }

MasterGILControl::~MasterGILControl() { end_allow_threading(); }
...
EnsurePythonGIL::EnsurePythonGIL() { scoped_state_ = PyGILState_Ensure(); }
