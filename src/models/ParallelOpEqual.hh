...
template <typename U, typename DoubleType> struct SerialVectorVectorOpEqual {
...
template <typename U, typename DoubleType> struct SerialVectorScalarOpEqual {
...
template <typename U> class OpEqualPacket {
public:
...
template <typename U> void OpEqualRun(U &, size_t /*length*/);

template <typename U> class OpEqualRange {
public:
