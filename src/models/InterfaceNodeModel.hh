...
/// This class has models which are always out of date and are always
/// recalculated
class InterfaceNodeModel {
public:
  ...
  ConstInterfaceNodeModelPtr GetConstSelfPtr() const { return myself.lock(); }

  InterfaceNodeModelPtr GetSelfPtr() { return myself.lock(); }
...
InterfaceNodeModelPtr create_interface_node_model(bool use_extended,
                                                  Args &&...args) {
