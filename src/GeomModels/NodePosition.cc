...
template <typename DoubleType> NodePosition<DoubleType>::~NodePosition() {}

template <typename DoubleType>
NodePosition<DoubleType>::NodePosition(RegionPtr rp)
    : NodeModel("x", rp, NodeModel::DisplayType::SCALAR) {
  yposition = CreateNodeSolution("y", rp, NodeModel::DisplayType::SCALAR,
                                 this->GetSelfPtr());
  zposition = CreateNodeSolution("z", rp, NodeModel::DisplayType::SCALAR,
                                 this->GetSelfPtr());
  node_index = CreateNodeSolution(
      "node_index", rp, NodeModel::DisplayType::SCALAR, this->GetSelfPtr());
  coordinate_index =
      CreateNodeSolution("coordinate_index", rp, NodeModel::DisplayType::SCALAR,
                         this->GetSelfPtr());
}
