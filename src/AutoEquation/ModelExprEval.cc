...
template <typename DoubleType> ModelExprEval<DoubleType>::~ModelExprEval() {}

template <typename DoubleType>
ModelExprData<DoubleType>
ModelExprEval<DoubleType>::EvaluateModelType(Eqo::EqObjPtr arg) {
  ...
  } else if (ConstTetrahedronEdgeModelPtr nm =
                 rp->GetTetrahedronEdgeModel(model)) {
    if (nm->IsInProcess()) {
      std::ostringstream os;
...
template <typename DoubleType>
ModelExprData<DoubleType>
ModelExprEval<DoubleType>::EvaluateVariableType(Eqo::EqObjPtr arg) {
...
#if defined(USE_MATERIALDB)
  const MaterialDB::DoubleDBEntry_t &mdbentr =
      mdb.GetDoubleDBEntry(data_ref->GetMaterialName(), nm);
  const MaterialDB::DoubleDBEntry_t &mdbentg =
      mdb.GetDoubleDBEntry("global", nm);
#endif
...
template <typename DoubleType>
ModelExprData<DoubleType>
ModelExprEval<DoubleType>::EvaluateProductType(Eqo::EqObjPtr arg) {
  ModelExprData<DoubleType> out;
  //
...
template <typename DoubleType>
ModelExprData<DoubleType>
ModelExprEval<DoubleType>::EvaluateIfType(Eqo::EqObjPtr arg) {
  ModelExprData<DoubleType> out;
...
template <typename DoubleType>
ModelExprData<DoubleType>
ModelExprEval<DoubleType>::EvaluateIfElseType(Eqo::EqObjPtr arg) {
  ModelExprData<DoubleType> out;
...
template <typename DoubleType>
ModelExprData<DoubleType>
ModelExprEval<DoubleType>::EvaluateAddType(Eqo::EqObjPtr arg) {
  ModelExprData<DoubleType> out;
...
template <typename DoubleType>
ModelExprData<DoubleType>
ModelExprEval<DoubleType>::EvaluateFunctionType(Eqo::EqObjPtr arg) {
  ModelExprData<DoubleType> out;
...
template <typename DoubleType>
ModelExprData<DoubleType>
ModelExprEval<DoubleType>::EvaluateInvalidType(Eqo::EqObjPtr arg) {
  ModelExprData<DoubleType> out;
...
template <typename DoubleType>
ModelExprData<DoubleType>
ModelExprEval<DoubleType>::EvaluateConstantType(Eqo::EqObjPtr arg) {
  ModelExprData<DoubleType> out;
...
template <typename DoubleType>
ModelExprData<DoubleType>
ModelExprEval<DoubleType>::eval_function(Eqo::EqObjPtr arg) {
  FPECheck::ClearFPE();
...
template <typename DoubleType> struct checks {
  bool allArgsSame;
  bool hasInvalid;
  bool hasEdgeData;
...
template <typename DoubleType>
ModelExprData<DoubleType>
ModelExprEval<DoubleType>::EvaluateExternalMath(const std::string &name,
                                                margv_t &argv) {
  bool invalid = false;
