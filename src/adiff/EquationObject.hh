...
public:
  ...
  EqObjPtr getReciprocal() { return con(1.0 / dvalue); }
...
public:
  const std::string &getVariableName() { return value; }
  ...
  std::vector<EqObjPtr> getArgs() { return createArgs(shared_from_this()); }
