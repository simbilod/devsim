...
template <> TimeData<double> *TimeData<double>::instance = 0;

#ifdef DEVSIM_EXTENDED_PRECISION
#include "Float128.hh"
template <> TimeData<float128> *TimeData<float128>::instance = 0;
#endif
...
template <typename DoubleType> TimeData<DoubleType>::~TimeData() {}

template <typename DoubleType> void TimeData<DoubleType>::DestroyInstance() {
  delete instance;
  instance = nullptr;
}
