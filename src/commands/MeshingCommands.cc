...
void create1dMeshCmd(CommandHandler &data) {
  ...
  static dsGetArgs::Option option[] = {
      {"mesh", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, meshCannotExist},
...
void finalizeMeshCmd(CommandHandler &data) {
  std::string errorString;
  ...
  static dsGetArgs::Option option[] = {
      {"mesh", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, meshMustNotBeFinalized},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr}};
...
void deleteMeshCmd(CommandHandler &data) {
  std::string errorString;
  ...
  static dsGetArgs::Option option[] = {
      {"mesh", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, meshMustExist},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr}};
...
void getMeshListCmd(CommandHandler &data) {
  std::string errorString;
...
void add1dMeshLineCmd(CommandHandler &data) {
  std::string errorString;
  ...
  static dsGetArgs::Option option[] = {
      {"mesh", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, meshMustNotBeFinalized},
      {"tag", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {"pos", "0", dsGetArgs::optionType::FLOAT,
       dsGetArgs::requiredType::REQUIRED, nullptr},
      /// this will default to plus spacing
      {"ns", "0", dsGetArgs::optionType::FLOAT,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {"ps", "0", dsGetArgs::optionType::FLOAT,
       dsGetArgs::requiredType::REQUIRED, mustBePositive},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr}};
...
void add2dMeshLineCmd(CommandHandler &data) {
  std::string errorString;
  ...
  static dsGetArgs::Option option[] = {
      ...
      {"ps", "0", dsGetArgs::optionType::FLOAT,
       dsGetArgs::requiredType::REQUIRED, mustBePositive},
      {"dir", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, nullptr},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr}};
...
void add1dInterfaceCmd(CommandHandler &data) {
  std::string errorString;
...
void add1dContactCmd(CommandHandler &data) {
  std::string errorString;
  ...
  static dsGetArgs::Option option[] = {
      ...
      {"name", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"material", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"tag", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
...
void add2dInterfaceCmd(CommandHandler &data) {
  std::string errorString;
  ...
  static dsGetArgs::Option option[] = {
      ...
      {"name", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"region0", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"region1", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"xl", "-MAXDOUBLE", dsGetArgs::optionType::FLOAT,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {"xh", "MAXDOUBLE", dsGetArgs::optionType::FLOAT,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {"yl", "-MAXDOUBLE", dsGetArgs::optionType::FLOAT,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {"yh", "MAXDOUBLE", dsGetArgs::optionType::FLOAT,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {"bloat", "1.0e-10", dsGetArgs::optionType::FLOAT,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr}};
  ...
  if (!m2dp) {
    ...
    if (region0Name == region1Name) {
      std::ostringstream os;
      os << region0Name
         << " cannot be specified for both region0 and region1\n";
      data.SetErrorResult(os.str());
      return;
    } else {
      dsMesh::MeshInterface2dPtr ip(
          new dsMesh::MeshInterface2d(name, region0Name, region1Name));
...
void add2dContactCmd(CommandHandler &data) {
  std::string errorString;
  ...
  if (!m2dp) {
    ...
    dsMesh::MeshContact2dPtr cp(
        new dsMesh::MeshContact2d(name, materialName, regionName));
    m2dp->AddContact(cp);
    dsMesh::BoundingBox bb(xl, xh, yl, yh, bl);
...
void add1dRegionCmd(CommandHandler &data) {
  std::string errorString;
  ...
  static dsGetArgs::Option option[] = {
      ...
      {"material", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"tag1", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"tag2", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr}};
  ...
  if (!m1dp) {
    ...
    m1dp->AddRegion(
        dsMesh::MeshRegion1d(regionName, materialName, tagName1, tagName2));
    data.SetEmptyResult();
  }
}

void add2dRegionCmd(CommandHandler &data) {
  std::string errorString;
  ...
  if (!m2dp) {
    ...
    dsMesh::MeshRegion2dPtr rp(
        new dsMesh::MeshRegion2d(regionName, materialName));
    m2dp->AddRegion(rp);
    dsMesh::BoundingBox bb(xl, xh, yl, yh, bl);
...
void createDeviceCmd(CommandHandler &data) {
  std::string errorString;
  ...
  static dsGetArgs::Option option[] = {
      {"mesh", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, meshMustBeFinalized},
      {"device", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, mustNotBeValidDevice},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
...
void deleteDeviceCmd(CommandHandler &data) {
  std::string errorString;
...
void loadDevicesCmd(CommandHandler &data) {
  std::string errorString;
  ...
  // TODO:  "specify option to only load the mesh creator, but don't
  // instantiate"
  static dsGetArgs::Option option[] = {
      {"file", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, nullptr},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr}};
...
void writeDevicesCmd(CommandHandler &data) {
  std::string errorString;
  ...
  if (type.empty() || (type == "devsim")) {
...
#else
    errorString +=
        "VTK support was not built into this version.  Please select from "
        "\"devsim\", \"devsim_data\", \"floops\", or \"tecplot\".\n";
    data.SetErrorResult(errorString);
    return;
#endif
    ...
    errorString += "type: " + type +
                   " is not a valid type.  Please select from \"devsim\", "
                   "\"devsim_data\", \"floops\", \"vtk\", or \"tecplot\".\n";
    data.SetErrorResult(errorString);
    return;
  }
...
void createGmshMeshCmd(CommandHandler &data) {
  ...
  static dsGetArgs::Option option[] = {
      ...
      {"file", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {"coordinates", "", dsGetArgs::optionType::LIST,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {"physical_names", "", dsGetArgs::optionType::LIST,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {"elements", "", dsGetArgs::optionType::LIST,
       dsGetArgs::requiredType::OPTIONAL, nullptr},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr}};
...

  {
    ...
    if (cdata.IsList()) {
      ...
      if (!ok) {
        std::ostringstream os;
        os << "Option \"coordinates\" could not be converted to a list of "
              "doubles\n";
        errorString += os.str();
      }
    }
...

  {
    ...
    if (pdata.IsList()) {
      ...
      if (!ok) {
        std::ostringstream os;
        os << "Option \"physical_names\" could not be converted to a list of "
              "strings\n";
        errorString += os.str();
      }
    }
...

  {
    ...
    if (edata.IsList()) {
      ...
      if (!ok) {
        std::ostringstream os;
        os << "Option \"elements\" could not be converted to a list of "
              "unsigned\n";
        errorString += os.str();
      }
    }
  ...
  if (load_file && (load_argcount > 0)) {
    std::ostringstream os;
    os << "Option \"file\" cannot be mixed with \"coordinates\", \"elements\", "
          "and \"physical_names\"\n";
    errorString += os.str();
    ret = false;
  } else if (load_file) {
    ...
    ret = dsGmshParse::LoadMeshesFromArgs(meshName, coordinates, physical_names,
                                          elements, errorString);
  } else if (load_argcount > 0) {
    std::ostringstream os;
    os << "\"coordinates\", \"elements\", and \"physical_names\" are all "
          "required together\n";
    errorString += os.str();
    ret = false;
  } else {
...
void addGmshInterfaceCmd(CommandHandler &data) {
  std::string errorString;
  ...
  static dsGetArgs::Option option[] = {
      ...
      {"name", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"gmsh_name", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"region0", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"region1", "", dsGetArgs::optionType::STRING,
...
void addGmshContactCmd(CommandHandler &data) {
  std::string errorString;
...
void addGmshRegionCmd(CommandHandler &data) {
  std::string errorString;
...
/**
Unlike the other mesh commands, this one is to be called after the device has
been instantiated
*/
void createContactFromInterfaceCmd(CommandHandler &data) {
  std::string errorString;
  ...
  static dsGetArgs::Option option[] = {
      ...
      {"interface", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, mustBeValidInterface},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr}};
  ...
  if (interface->GetRegion0() == region) {
    contact =
        new Contact(contactName, region, interface->GetNodes0(), materialName);
    contact->AddTriangles(interface->GetTriangles0());
    contact->AddEdges(interface->GetEdges0());
  } else if (interface->GetRegion1() == region) {
    contact =
        new Contact(contactName, region, interface->GetNodes1(), materialName);
    contact->AddTriangles(interface->GetTriangles1());
    contact->AddEdges(interface->GetEdges1());
  } else {
    std::ostringstream os;
    os << onInterfaceonDevice(interfaceName, deviceName)
       << " is not attached to region \"" << regionName << "\".\n";
    errorString = os.str();
    data.SetErrorResult(errorString);
    return;
  }
...
void createInterfaceFromNodesCmd(CommandHandler &data) {
  ...
  static dsGetArgs::Option option[] = {
      ...
      {"region1", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, mustBeValidRegion},
      {"nodes0", "", dsGetArgs::optionType::LIST,
       dsGetArgs::requiredType::REQUIRED, nullptr},
      {"nodes1", "", dsGetArgs::optionType::LIST,
       dsGetArgs::requiredType::REQUIRED, nullptr},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL}};
  ...
  for (size_t i = 0; i < 2; ++i) {
    errorString +=
        ValidateDeviceAndRegion(deviceName, regionNames[i], dev, reg[i]);
  }
  ...
  for (size_t i = 0; i < 2; ++i) {
    ...
    if (vdata.IsList()) {
      ...
      if (!ok) {
        std::ostringstream os;
        os << "Option \"" << oname
           << "\" could not be converted to a list of unsigned integers\n";
        errorString += os.str();
      }
    }
  }
  ...
  if ((nodes[0].empty() || nodes[1].empty()) ||
    ...
    std::ostringstream os;
    os << "Node lists \"nodes0\", \"nodes1\" are empty or not the same size "
       << nodes[0].size() << " " << nodes[1].size() << "\n";
    errorString = os.str();
    data.SetErrorResult(errorString);
    return;
