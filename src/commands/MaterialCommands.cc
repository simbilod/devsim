...
void getParameterCmd(CommandHandler &data) {
  ...
  if (commandName == "set_parameter") {
    static dsGetArgs::Option setoption[] = {
        ...
        {"value", "", dsGetArgs::optionType::STRING,
         dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
    ...
    static dsGetArgs::Option getoption[] = {
        {"device", "", dsGetArgs::optionType::STRING,
         dsGetArgs::requiredType::OPTIONAL, mustBeSpecifiedIfRegionSpecified},
        {"region", "", dsGetArgs::optionType::STRING,
         dsGetArgs::requiredType::OPTIONAL, nullptr},
        {"name", "", dsGetArgs::optionType::STRING,
         dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
    ...
    static dsGetArgs::Option getoption[] = {
        {"device", "", dsGetArgs::optionType::STRING,
         dsGetArgs::requiredType::OPTIONAL, mustBeValidDevice},
        {nullptr, nullptr, dsGetArgs::optionType::STRING,
         dsGetArgs::requiredType::OPTIONAL, nullptr}};
    option = getoption;
  } else {
...
#if defined(USE_MATERIALDB)
void openDBCmd(CommandHandler &data) {
  std::string errorString;
  ...
  if (commandName == "open_db") {
    static dsGetArgs::Option openoption[] = {
        {"filename", "", dsGetArgs::optionType::STRING,
         dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
        {"permission", "readonly", dsGetArgs::optionType::STRING,
         dsGetArgs::requiredType::OPTIONAL, nullptr},
        {nullptr, nullptr, dsGetArgs::optionType::STRING,
         dsGetArgs::requiredType::OPTIONAL, nullptr}};
    option = openoption;
...
void addDBEntryCmd(CommandHandler &data) {
  std::string errorString;
  ...
  static dsGetArgs::Option openoption[] = {
      {"material", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"parameter", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"value", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, stringCannotBeEmpty},
      {"unit", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, nullptr},
      {"description", "", dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::REQUIRED, nullptr},
      {nullptr, nullptr, dsGetArgs::optionType::STRING,
       dsGetArgs::requiredType::OPTIONAL, nullptr}};
  ...
  mdb.AddDBEntry(material, parameter,
                 MaterialDBEntry(unit, description, ObjectHolder(value),
                                 MaterialDBEntry::EntryType_t::MODIFIED));
  data.SetEmptyResult();
}

void getDBEntryCmd(CommandHandler &data) {
  std::string errorString;
...
#else
void MaterialCommandMissing(CommandHandler &data) {
  std::string errorString;
  std::ostringstream os;
  const std::string commandName = data.GetCommandName();
  os << "Material database command \"" << commandName
...
Commands MaterialCommands[] = {{"set_parameter", getParameterCmd},
